...
class CC: #i used CC here because CyberCrime will be a long keyword
    def __init__(self,root):
        ...
        frame3_1.place(x=120,y=54,width=146,height=26)
        b33_male=Radiobutton(frame3_1, text='Male',value='Male',font=("Arial",7),bg='white')
        b33_male.grid(row=0,column=0,pady=0,padx=0,sticky=W)
        b33_female=Radiobutton(frame3_1, text='Female',value='Female',font=("Arial",7),bg='white')
        b33_female.grid(row=0,column=1,pady=0,padx=0,sticky=W)
        ...
        frame3_2.place(x=677,y=54,width=146,height=26)
        b33_male=Radiobutton(frame3_2, text='Male',value='Male',font=("Arial",7),bg='white')
        b33_male.grid(row=0,column=0,pady=0,padx=0,sticky=W)
        b33_female=Radiobutton(frame3_2, text='Female',value='Female',font=("Arial",7),bg='white')
        b33_female.grid(row=0,column=1,pady=0,padx=0,sticky=W)
