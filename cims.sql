CREATE DATABASE  IF NOT EXISTS `cims_data` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `cims_data`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: cims_data
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `cybersecurity`;
...
LOCK TABLES `cybersecurity` WRITE;
/*!40000 ALTER TABLE `cybersecurity` DISABLE KEYS */;
/*!40000 ALTER TABLE `cybersecurity` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-27 17:18:00
