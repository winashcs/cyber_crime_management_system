...
class CC: #i used CC here because CyberCrime will be a long keyword
    def __init__(self,root):
        ...
        b33=ttk.Entry(frame2_1,width=20,font=("Times New Roman",10,'bold'))
        b33.grid(row=2,column=1,padx=2,sticky=W,pady=2)
